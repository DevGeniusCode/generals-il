        ...
        <section className="card-section">
            <div className="card">
                <div className="card-content">
                    ...
                    <img src="/public/images/card-command.jpg" alt="לפקד" className="card-image" />
                </div>
            </div>
            <div className="card">
                <div className="card-content reverse">
                    <img src="/public/images/card-counqer.webp" alt="לכבוש" className="card-image" />
                    <div className="card-text">
                        <h2>לכבוש</h2>
            ...
            <div className="card">
                <div className="card-content">
                    ...
                    <img src="/public/images/card-win.webp" alt="לנצח" className="card-image" />
                </div>
            </div>
        </section>
    );
